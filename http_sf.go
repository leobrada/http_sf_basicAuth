...
import (
    ...
    basic_auth "github.com/leobrada/http_sf_basicAuth/sf_basic_auth"
)
...
func main() {
    ...
    sf_basic_auth := basic_auth.NewSFBasicAuth()
    router, err := router.NewRouter(data_plane_sf_cert, accepted_certs_pem, sf_basic_auth)
    if err != nil {
        log.Panicf("%v\n", err)
    }
